...
# {{ header("Workshop - Python Programme ausführen?", "Workshop - Running Python Programs?") }}
...
# - Um Python-Code auszuführen, können Sie eine sogenannte Entwicklungsumgebung verwenden oder Jupyter Notebooks
...
# - Das Ausführen von Python erfordert nicht immer Installation und Einrichtung auf Ihrem lokalen Rechner.
# - Für Einsteiger in die Sprache kann der direkte Einstieg im Browser die Einstiegshürde senken.
# - Es gibt zahlreiche Plattformen dafür, wie z.B. PythonAnywhere, Jupyter Notebooks, Google Colab, etc. Diese Plattformen ermöglichen es Ihnen, Python-Code in einer interaktiven Umgebung zu schreiben und auszuführen.
