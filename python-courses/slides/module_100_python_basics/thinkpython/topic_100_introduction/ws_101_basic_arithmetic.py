...
# {{ header("Workshop - Arithmetik", "Workshop - Arithmetic") }}
...
# - Arithmetische Operatoren werden verwendet, um mathematische Operationen in Python durchzuführen.
# - Die grundlegenden arithmetischen Operatoren in Python sind:
#     - Addition: +
#     - Subtraktion: -
#     - Multiplikation: *
#     - Division: /
