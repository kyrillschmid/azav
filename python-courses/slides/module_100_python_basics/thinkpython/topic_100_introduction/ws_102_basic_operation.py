...
# {{ header("Workshop - Grundlegende Operationen", "Workshop - Basic Operations") }}
...
# - This could involve various activities like mathematical operations, data processing, conditional execution, and repetition among others.
# - In this workshop, we will get a taste of these concepts.

# %% [markdown] lang="de" tags=["subslide"]
#
# Ein Programm ist eine Abfolge von Anweisungen, die angibt, wie eine Berechnung durchgeführt wird.
# - Dies kann verschiedene Aktivitäten wie mathematische Operationen, Datenverarbeitung, bedingte Ausführung und Wiederholung umfassen.
# - In diesem Workshop werden wir einen Einblick in diese Konzepte erhalten.
